package com.example.ShoppingCartsecurity.Controller;
...
import com.example.ShoppingCartsecurity.Entity.Basket;
import com.example.ShoppingCartsecurity.Entity.Customer;
import com.example.ShoppingCartsecurity.Entity.Items;
import com.example.ShoppingCartsecurity.Entity.ShoppingCart;
...
public class HomeController {
    ...
    public void addcustomers(){
        ...
        shoppingCart.add_item(new Items("Soap",45.5,8000));
        shoppingCart.add_item(new Items("Shampoo",400.0,520));
        shoppingCart.add_item(new Items("Biscuits",200.0,320));
        shoppingCart.add_customer(new Customer("Sara","12457854",new Basket()));
        shoppingCart.add_customer(new Customer("Ayesha","87417854",new Basket()));
        shoppingCart.add_customer(new Customer("Emma","958417854",new Basket()));
    }
